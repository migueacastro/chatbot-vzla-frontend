...
<div class="w-full max-w-none px-4 md:px-8 py-4 flex flex-col h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)]">
	<!-- Banner de Aviso de Emergencia Oficial -->
	{#if showWarning}
		<div class="alert alert-warning py-2.5 px-4 rounded-2xl text-xs sm:text-sm font-bold flex justify-between items-center gap-2.5 mb-4 shadow-sm border border-warning/20 shrink-0">
	...
	<!-- Vista móvil para el panel de emergencias (visible solo en pantallas pequeñas) -->
	<div class="block lg:hidden mt-4 shrink-0">
		<div class="collapse collapse-arrow bg-base-200 border border-base-300 rounded-3xl">
			<input type="checkbox" aria-label="Ver contactos de emergencia" />
			<div class="collapse-title text-base font-extrabold flex items-center gap-2 py-4 px-5">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
				...
				Contactos Rápidos de Emergencia
			</div>
